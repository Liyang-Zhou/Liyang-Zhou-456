...
public class TFIDFSearchFiles {
    ...
    private static final String DEFAULT_SEARCH_FIELD = "contents";

    public TFIDFSearchFiles() {

    }

    public static void main(String[] args) throws Exception {
        String usage = "java org.apache.lucene.demo.TFIDFSearchFiles" +
        ...
        String field = DEFAULT_SEARCH_FIELD;
        String queries = null;
        int repeat = 0;
        boolean raw = false;
        ...
        while (true) {
            ...
            String line = queryString != null ? queryString : bufferedReader.readLine();
            ...
            doPagingSearch(bufferedReader, searcher, query, hitsPerPage, raw, queries == null && queryString == null);
            ...
            for (int i = start; i < end; i++) {
                ...
                if (path != null) {
                    ...
                    if (title != null) {
                        ...
                        System.out.println("   TFIDFSimilarity-Score: " + hits[i].score);
